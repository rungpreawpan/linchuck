...
//         children: [
//           Expanded(
//             child: _homeController.selectedOrderDetail.isNotEmpty
//                 ? ListView.separated(
//                     itemCount: _homeController.selectedOrderDetail.length,
//                     itemBuilder: (context, index) {
//                       SelectedProductModel item =
//                           _homeController.selectedOrderDetail[index];
//
//                       return _selectedProduct(
//                         product: item.product?.name ?? '',
//                         quantity: item.quantity ?? 0,
//                         price: double.parse(item.product!.productPrice.toString())
//                         // product: item.name ?? '',
//                         // quantity: item.quantity ?? 0,
